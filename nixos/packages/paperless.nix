# Vendored from nixpkgs-unstable.
{
  config,
  options,
  pkgs,
...
in
{
  options.feline.paperless = {
    ...
    exporter = {
      ...
      directory = lib.mkOption {
        ...
        defaultText = lib.literalExpression "\${config.feline.paperless.dataDir}/export";
  ...
  config = lib.mkIf cfg.enable (
    lib.mkMerge [
      {
        feline.paperless.manage = manage;
        ...
        services.nginx = lib.mkIf cfg.configureNginx {
          ...
          virtualHosts.${cfg.domain} = {
            ...
            locations = {
              ...
              "/static/" = {
                root = config.feline.paperless.package;
                extraConfig = ''
        ...
        services.postgresql = lib.mkIf cfg.database.createLocally {
          ...
          ensureUsers = [
            {
              name = config.feline.paperless.user;
      ...
      (lib.mkIf cfg.exporter.enable {
        ...
        feline.paperless.exporter.settings = options.feline.paperless.exporter.settings.default;
